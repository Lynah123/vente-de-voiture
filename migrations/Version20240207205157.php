 ...
 */
final class Version20240207205157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE productDetailsDROP category_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE productDetailsADD category_id INT DEFAULT NULL');
