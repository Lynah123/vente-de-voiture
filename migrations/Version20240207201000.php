...
final class Version20240207201000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP type_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD type_id INT DEFAULT NULL');
