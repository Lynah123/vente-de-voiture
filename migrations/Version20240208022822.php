...
final class Version20240208022822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD brand_id INT DEFAULT NULL, ADD type_id INT DEFAULT NULL, ADD category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP brand_id, DROP type_id, DROP category_id');
    }
}
